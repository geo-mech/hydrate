...
def GAS_den(P, T):
    ...
    """
    mol = [0.499 / 100, 86.802 / 100, 0.426 / 100, 8.541 / 100, 1.331 / 100, 0.923 / 100, 0.476 / 100]
    MW = [2.016 / 1000, 28.013 / 1000, 44.01 / 1000, 16.043 / 1000, 30.07 / 1000, 44.097 / 1000, 58.123 / 1000]
    TC = [33.18, 126.10, 304.19, 190, 305.42, 369.82, 425.18]
    PC = [13.13 * 1.0e5, 33.94 * 1.0e5, 73.82 * 1.0e5, 46.04 * 1.0e5, 48.8 * 1.0e5, 42.49 * 1.0e5, 37.97 * 1.0e5]
