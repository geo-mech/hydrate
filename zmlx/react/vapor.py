...
def test_1():
    ...
    vp = [exp(9.3876 - 3826.36 / (t - 45.47)) * 1.0e6 for t in vt]
    vt1 = [455, 460, 465, 470, 475, 480, 485, 490, 495, 500, 505, 510, 515, 520,
           525, 530, 535, 540, 545,
           550, 555, 560, 565, 570, 575, 580, 585, 590, 595, 600]

    vp1 = [1.0462e6, 1.1709e6, 1.3069e6, 1.4551e6, 1.6160e6, 1.7905e6, 1.9792e6,
           2.1831e6, 2.4028e6, 2.6392e6, 2.8931e6,
           3.1655e6, 3.4571e6, 3.7690e6, 4.1019e6, 4.4569e6, 4.8349e6, 5.2369e6,
           5.6640e6,
