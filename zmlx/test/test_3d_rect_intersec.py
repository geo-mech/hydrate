...
# 保存相交矩形序号
np.savetxt('D:/Daily/2023.06.15 矩形相交算法/demo_links.txt', links, fmt='%4d')
...
# 保存相交矩形顶点坐标
np.savetxt('D:/Daily/2023.06.15 矩形相交算法/vertices.txt', rc3, fmt='%05f')
...
# 保存计算得到相交矩形序号
np.savetxt('D:/Daily/2023.06.15 矩形相交算法/cal_links.txt', np.array(test_links),fmt='%4d') 
