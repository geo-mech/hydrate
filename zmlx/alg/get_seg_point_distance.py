...
from zmlx.alg.get_point_distance import get_point_distance
from zmlx.alg.triangle_area import triangle_area


def get_seg_point_distance(seg, point):
    """
...
if __name__ == '__main__':
    ...
    p2 = (1, 0, 0)
    p3 = (2, 0, 0)
    print(get_seg_point_distance((p1, p2), p3))
