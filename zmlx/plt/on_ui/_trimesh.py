from zmlx.plt.on_axes import add_trimesh
from zmlx.plt.on_figure import plot_on_axes


def show_trimesh(triangles, points, linewidth=1.0, gui_mode=None, **opts):
    """
    ...
    plot_on_axes(add_trimesh,
                 triangles, points, linewidth=linewidth, gui_mode=gui_mode,
                 **opts
                 )
...
def test():
    ...
    # 绘制三角形网格
    show_trimesh(triangles=triangles, points=points, gui_mode=True)
