...
def test5():
    ...
    setLabel('left', "Y Axis", units='A')
    setLabel('bottom', "Y Axis", units='s')
    setLogMode(x=True, y=False)
...
def test9():
    setAxisItems(axisItems={'bottom': pg.DateAxisItem()})
    showGrid(x=True, y=True)
    now = time.time()
...
def test10():
    ...
    plt2.setData(vals, y, pen=None, symbol='o', symbolSize=5, symbolPen=(255, 255, 255, 200), symbolBrush=(0, 0, 255, 150))
