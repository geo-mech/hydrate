...
class ConfigV2:
    ...
    def __init__(
            self, has_co2=False, has_steam=False, has_inh=False,
    ...
    def get_fludefs(self, h2o_density=None, co2=None):
        ...
        创建流体的定义.
        """
        return create_fludefs(
            h2o_density=h2o_density, co2_def=co2,
    ...
    def reactions(self):
        ...
        return create_reactions(
            support_ch4_hyd_diss=self.support_ch4_hyd_diss,
    ...
    def caps(self):
        ...
        """
        return create_caps(
            ch4_diff=self.ch4_diff, inh_diff=self.inh_diff)
